...
from models import (cnn, C3DNet, resnet, ResNetV2, ResNeXt, ResNeXtV2, WideResNet, PreActResNet,
                    EfficientNet, DenseNet, ShuffleNet, ShuffleNetV2, SqueezeNet, MobileNet, MobileNetV2, vgg2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--manual_seed', default=1421, type=int, help='Mannual seed')
    parser.add_argument('--cnn_name', default='resnet', type=str, help='cnn model names')
    parser.add_argument('--model_depth', default=18, type=int, help='model depth (18|34|50|101|152|200)')
